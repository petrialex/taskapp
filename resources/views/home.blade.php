...
@section('content')
                            ...
                            <ul class="menu">
                                @foreach($projects as $projectDetails)
                                    ...
                                    <li class="menu-item  <?php echo ($project && $projectDetails->id == $project->id) ? 'has-active' : ''; ?>">
                                        <a href="{{ route('home') }}?project={{ $projectDetails->id }}"
    ...
    <main class="app-main">
        ...
        <div class="wrapper">
                        ...
                        @foreach ($statuses as $status)
                            <div class="tasks">
                                ...
                                <div class="task-header">
                                    ...
                                    <div class="dropdown">
                                        <!-- .btn -->
                                        <button class="btn btn-light btn-icon text-muted" data-toggle="dropdown"><i
                                                class="fa fa-ellipsis-v"></i></button> <!-- /.btn -->
                                        <!-- .dropdown-menu -->
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <div class="dropdown-arrow"></div>
                                            <a href="#" class="dropdown-item">Edit</a> <a href="#"
                                                                                          class="dropdown-item">Move</a>
                                            <a href="#" class="dropdown-item">Duplicate</a> <a href="#"
                                                                                               class="dropdown-item">Subcribe</a>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-header">
                                                    <div class="task-label-group">
                                                        <span class="task-label bg-teal"></span> <span
                                                            class="task-label bg-green"></span>
                                                    </div>
                                                    <h4 class="card-title">
                                                        <a href="#" data-toggle="modal"
                                                           data-target="#modalViewTask">{{ $task->title }}</a>
                                                    </h4>
                                                        ...
                                                        <div class="list-group-item" data-toggle="modal"
                                                            ...
                                                            <div class="list-group-item-body">
                                                                ...
                                                                <figure class="user-avatar user-avatar-sm"
                                                                        ...
                                                                        data-original-title="Johnny Day">
                                                                    <img
                                                ...
                                                <div class="card-footer">
                                                    <a href="#"
                                                       ...
                                                       data-toggle="modal" data-target="#modalViewTask"
                                                       draggable="false"><i class="fa fa-comments mr-1"></i> 36</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-alt flatpickr" data-toggle="flatpickr"
                                                ...
                                                <input name="taskDueDate" id="taskDueDate" type="text"
                                                       class="form-control flatpickr-input" data-input=""
                                                       readonly="readonly">
            ...
            <!-- .modal -->
            <div class="modal modal-drawer fade has-shown" id="modalViewTask" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-body p-3 p-lg-4">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active">
                                    <a href="#" data-dismiss="modal"><i
                                            class="breadcrumb-icon fa fa-angle-left mr-2"></i>In Progress</a>
                                </li>
                            </ol>
                            <h5 id="modalViewTaskLabel" class="modal-title"> Ride a Roller Coaster </h5>
                            <hr>
                            <p class="text-muted"> Opened one week ago by <a href="#" class="link-text"
                                                                             data-toggle="tooltip" title=""
                                                                             data-original-title="@jgrif"><span
                                        class="user-avatar user-avatar-xs"><img
                                            src="https://uselooper.com/assets/images/avatars/uifaces6.jpg"
                                            alt=""></span> Jacob Griffin</a>
                            </p>
                            <hr>
                            <div class="task-description">
                                <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus perferendis
                                    magnam fugit veritatis numquam perspiciatis. Mollitia optio vero eum velit,
                                    recusandae! Amet in consectetur expedita repellat, obcaecati non deserunt
                                    molestias. </p>
                            </div>
                            <div class="row my-3">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <div class="time-tracking">
                                        ...
                                        <span class="counter ml-1"><span class="hours">00</span> <span class="separtor">:</span> <span
                                                class="minutes">00</span> <span class="separtor">:</span> <span
                                                class="second">00</span></span> / <span class="estimate">8h</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-3">
                                    <h6> Labels </h6><span class="tile bg-green"></span> <span
                                        class="tile bg-pink"></span> <span class="tile bg-yellow"></span>
                                    <div class="dropdown d-inline-block">
                                        <a href="#" class="tile" data-toggle="dropdown" aria-haspopup="true"
                                           aria-expanded="false"><i class="fa fa-plus"></i></a> <!-- .dropdown-menu -->
                                        <div class="dropdown-menu dropdown-menu-md stop-propagation" id="dntmLabels"
                                             aria-labelledby="dropdownTaskLabels2" style="">
                                            <h6 id="dropdownTaskLabels2" class="dropdown-header"> Select labels </h6>
                                            <div class="dropdown-divider"></div>
                                            <div class="form-group px-3 py-2 mb-0">
                                                <input type="text" class="form-control"
                                                       data-filter="#dntmLabels .filterable" placeholder="Search"
                                                       data-autofocus="true">
                                            </div>
                                            <label class="custom-control custom-checkbox filterable"><input
                                                    type="checkbox" class="custom-control-input task-nolabel"
                                                    name="taskLabels[]" value="0" data-label="No Label" checked="">
                                                <span class="custom-control-label">No Label</span></label>
                                            <div class="dropdown-divider"></div>
                                            <div class="dropdown-scroll">
                                                <label class="custom-control custom-checkbox filterable"><input
                                                        type="checkbox" class="custom-control-input task-label"
                                                        name="taskLabels[]" value="1"
                                                        data-label="https://uselooper.com/assets"> <span
                                                        class="custom-control-label"><i
                                                            class="fa fa-square fa-lg text-blue mr-1"></i> Assets</span></label>
                                                <label class="custom-control custom-checkbox filterable"><input
                                                        type="checkbox" class="custom-control-input task-label"
                                                        name="taskLabels[]" value="2" data-label="Build Tools"> <span
                                                        class="custom-control-label"><i
                                                            class="fa fa-square fa-lg text-indigo mr-1"></i> Build Tools</span></label>
                                                <label class="custom-control custom-checkbox filterable"><input
                                                        type="checkbox" class="custom-control-input task-label"
                                                        name="taskLabels[]" value="3" data-label="Components"> <span
                                                        class="custom-control-label"><i
                                                            class="fa fa-square fa-lg text-purple mr-1"></i> Components</span></label>
                                                <label class="custom-control custom-checkbox filterable"><input
                                                        type="checkbox" class="custom-control-input task-label"
                                                        name="taskLabels[]" value="4" data-label="Dependencies"> <span
                                                        class="custom-control-label"><i
                                                            class="fa fa-square fa-lg text-pink mr-1"></i> Dependencies</span></label>
                                                <label class="custom-control custom-checkbox filterable"><input
                                                        type="checkbox" class="custom-control-input task-label"
                                                        name="taskLabels[]" value="5" data-label="Design"> <span
                                                        class="custom-control-label"><i
                                                            class="fa fa-square fa-lg text-red mr-1"></i> Design</span></label>
                                                <label class="custom-control custom-checkbox filterable"><input
                                                        type="checkbox" class="custom-control-input task-label"
                                                        name="taskLabels[]" value="6" data-label="Documentation"> <span
                                                        class="custom-control-label"><i
                                                            class="fa fa-square fa-lg text-orange mr-1"></i> Documentation</span></label>
                                                <label class="custom-control custom-checkbox filterable"><input
                                                        type="checkbox" class="custom-control-input task-label"
                                                        name="taskLabels[]" value="7" data-label="Doing"> <span
                                                        class="custom-control-label"><i
                                                            class="fa fa-square fa-lg text-yellow mr-1"></i> Doing</span></label>
                                                <label class="custom-control custom-checkbox filterable"><input
                                                        type="checkbox" class="custom-control-input task-label"
                                                        name="taskLabels[]" value="8" data-label="JS"> <span
                                                        class="custom-control-label"><i
                                                            class="fa fa-square fa-lg text-green mr-1"></i> JS</span></label>
                                                <label class="custom-control custom-checkbox filterable"><input
                                                        type="checkbox" class="custom-control-input task-label"
                                                        name="taskLabels[]" value="9" data-label="SCSS"> <span
                                                        class="custom-control-label"><i
                                                            class="fa fa-square fa-lg text-teal mr-1"></i> SCSS</span></label>
                                                <label class="custom-control custom-checkbox filterable"><input
                                                        type="checkbox" class="custom-control-input task-label"
                                                        name="taskLabels[]" value="10" data-label="To Do"> <span
                                                        class="custom-control-label"><i
                                                            class="fa fa-square fa-lg text-cyan mr-1"></i> To Do</span></label>
                                            </div>
                                            <div class="dropdown-divider"></div>
                                            <a href="#" class="dropdown-item">Create new label</a> <a href="#"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <div class="assignee">
                                        ...
                                        <div class="avatar-group">
                                            <a href="#" class="user-avatar" data-toggle="tooltip" title=""
                                               data-original-title="You"><img
                                                    src="https://uselooper.com/assets/images/avatars/uifaces2.jpg"
                                                    alt="You"></a> <a href="#" class="user-avatar" data-toggle="tooltip"
                                                                      title="" data-original-title="Mellisa Day"><img
                                                    src="https://uselooper.com/assets/images/avatars/uifaces4.jpg"
                                                    alt="Mellisa Day"></a>
                                            <div class="dropdown d-inline-block">
                                                <a href="#" class="tile tile-circle" data-toggle="dropdown"
                                                   aria-haspopup="true" aria-expanded="false"><i class="fa fa-plus"></i></a>
                                                <!-- .dropdown-menu -->
                                                <div
                                                    class="dropdown-menu dropdown-menu-md overflow-auto stop-propagation"
                                                    aria-labelledby="dropdownAssignee2" style="max-height: 30rem;">
                                                    <h6 id="dropdownAssignee2" class="dropdown-header"> Add
                                                        assignee </h6>
                                                    <div class="dropdown-divider"></div>
                                                    <div class="form-group px-3 py-2 mb-0">
                                                        <input type="text" class="form-control"
                                                               placeholder="Search members" data-autofocus="true">
                                                    </div>
                                                    <label class="custom-control custom-checkbox"><input type="checkbox"
                                                                                                         class="custom-control-input task-unassignees"
                                                                                                         name="taskAssignees[]"
                                                                                                         value="0"
                                                                                                         data-label="Unassigned">
                                                        <span class="custom-control-label">Unassigned</span></label>
                                                    <div class="dropdown-divider"></div>
                                                    <h6 class="dropdown-header"> Assignee(s) </h6><label
                                                        class="custom-control custom-checkbox filterable"
                                                        data-sort="Beni Arisandi"><input type="checkbox"
                                                                                         class="custom-control-input task-assignees"
                                                                                         name="taskAssignees[]"
                                                                                         value="4"
                                                                                         data-label="Beni Arisandi"
                                                                                         checked=""> <span
                                                            class="custom-control-label custom-control-label-media"><span
                                                                class="media"><span class="mr-2"><span
                                                                        class="user-avatar"><img
                                                                            src="https://uselooper.com/assets/images/avatars/uifaces2.jpg"
                                                                            alt=""></span></span> <span
                                                                    class="media-body">Beni Arisandi<br>
                                      <span class="text-muted">@benz</span></span></span></span></label> <label
                                                        class="custom-control custom-checkbox filterable"
                                                        data-sort="Melissa Day"><input type="checkbox"
                                                                                       class="custom-control-input task-assignees"
                                                                                       name="taskAssignees[]" value="2"
                                                                                       data-label="Melissa Day"
                                                                                       checked=""> <span
                                                            class="custom-control-label custom-control-label-media"><span
                                                                class="media"><span class="mr-2"><span
                                                                        class="user-avatar"><img
                                                                            src="https://uselooper.com/assets/images/avatars/uifaces4.jpg"
                                                                            alt=""></span></span> <span
                                                                    class="media-body">Melissa Day<br>
                                      <span class="text-muted">@melday</span></span></span></span></label>
                                                    <div id="dntmDivider" class="dropdown-divider"></div>
                                                    <label class="custom-control custom-checkbox filterable"
                                                           data-sort="Adam Medina"><input type="checkbox"
                                                                                          class="custom-control-input task-assignees"
                                                                                          name="taskAssignees[]"
                                                                                          value="3"
                                                                                          data-label="Adam Medina">
                                                        <span
                                                            class="custom-control-label custom-control-label-media"><span
                                                                class="media"><span class="mr-2"><span
                                                                        class="user-avatar"><img
                                                                            src="https://uselooper.com/assets/images/avatars/uifaces15.jpg"
                                                                            alt=""></span></span> <span
                                                                    class="media-body">Adam Medina<br>
                                      <span class="text-muted">@amed</span></span></span></span></label> <label
                                                        class="custom-control custom-checkbox filterable"
                                                        data-sort="Diana Miller"><input type="checkbox"
                                                                                        class="custom-control-input task-assignees"
                                                                                        name="taskAssignees[]" value="1"
                                                                                        data-label="Diana Miller"> <span
                                                            class="custom-control-label custom-control-label-media"><span
                                                                class="media"><span class="mr-2"><span
                                                                        class="user-avatar"><img
                                                                            src="https://uselooper.com/assets/images/avatars/uifaces9.jpg"
                                                                            alt=""></span></span> <span
                                                                    class="media-body">Diana Miller<br>
                                      <span class="text-muted">@dmiller</span></span></span></span></label> <label
                                                        class="custom-control custom-checkbox filterable"
                                                        data-sort="Douglas Lucas"><input type="checkbox"
                                                                                         class="custom-control-input task-assignees"
                                                                                         name="taskAssignees[]"
                                                                                         value="5"
                                                                                         data-label="Douglas Lucas">
                                                        <span
                                                            class="custom-control-label custom-control-label-media"><span
                                                                class="media"><span class="mr-2"><span
                                                                        class="user-avatar"><img
                                                                            src="https://uselooper.com/assets/images/avatars/uifaces5.jpg"
                                                                            alt=""></span></span> <span
                            ...
                            <div class="form-group">
                                ...
                                <div class="progress progress-sm">
                                    <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="66.67"
                            ...
                            <div class="form-group">
                                ...
                                <div id="vtTodos" class="todo-list">
                                    ...
                                    <div class="todo">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="vtodo0" value="0"
                                                   checked=""> <label class="custom-control-label" for="vtodo0">Eat corn
                                                on the cob</label>
                                        </div>
                                        <
                                    ...
                                    <div class="todo">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="vtodo1" value="1">
                                            <label class="custom-control-label" for="vtodo1">Mix up a pitcher of
                                                sangria</label>
                                        </div>
                                        <
                                    ...
                                    <div class="todo">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="vtodo2" value="2"
                                                   checked=""> <label class="custom-control-label" for="vtodo2">Have a
                                                barbecue</label>
                                        </div>
                                        <
                                ...
                                <div class="publisher">
                                    ...
                                    <div class="publisher-input pr-0">
                                        <input class="form-control form-control-reflow" placeholder="Add a todo"
                                               autocomplete="off">
                                    </div><!-- /.publisher-input -->
                                    <!-- .publisher-actions -->
                                    <div class="publisher-actions">
                                        ...
                                        <div class="publisher-tools pb-0">
                                            ...
                                            <button type="button" class="btn btn-light"><i class="fa fa-times"></i>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="publisher keep-focus focus">
                                        ...
                                        <div class="publisher-input">
                                            <textarea id="publisherInput7" class="form-control"
                                        ...
                                        <div class="publisher-actions">
                                            ...
                                            <div class="publisher-tools mr-auto">
                                                <div class="btn btn-light btn-icon fileinput-button">
                                                    <i class="fa fa-paperclip"></i> <input type="file" id="attachment7"
                                                                                           name="attachment7[]"
                                                                                           multiple="">
                                                </div>
